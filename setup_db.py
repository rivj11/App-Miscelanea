...
if __name__ == "__main__":
    ...
    # agregar_producto("Lapicero", "Papelería", 1500, 20, "Proveedor A")
    # Ejemplo de registrar una venta
    # registrar_venta(1, 2)
    # Ejemplo de registrar un gasto
    # registrar_gasto("Compra de material", 5000)
    # Ejemplo de calcular ganancias
    # print("Ganancias actuales:", calcular_ganancias())
